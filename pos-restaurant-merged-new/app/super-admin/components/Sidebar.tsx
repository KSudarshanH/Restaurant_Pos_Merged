    ...
    >
      ...
      <nav className="flex-1 px-2 py-6 space-y-1 text-sm">
        ...
        <SidebarItem
          ...
          active={pathname.startsWith("/super-admin/dashboard/restaurants")}
          collapsed={collapsed}
        />
        <SidebarItem
          label="Owners"
          href="/super-admin/dashboard/owners"
          active={pathname.startsWith("/super-admin/dashboard/owners")}
          collapsed={collapsed}
        />
        <SidebarItem
          label="Analytics"
          href="/super-admin/dashboard/analytics"
          active={pathname.startsWith("/super-admin/dashboard/analytics")}
          collapsed={collapsed}
        />
        <SidebarItem
          label="Settings"
          href="/super-admin/dashboard/settings"
          active={pathname.startsWith("/super-admin/dashboard/settings")}
          collapsed={collapsed}
        />
      </nav>
