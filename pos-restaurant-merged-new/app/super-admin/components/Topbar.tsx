...
function getPageTitle(pathname: string) {
  ...
  if (pathname.startsWith("/super-admin/dashboard/restaurants"))
    return "Restaurants";
  if (pathname.startsWith("/super-admin/dashboard/owners")) return "Owners";
  if (pathname.startsWith("/super-admin/dashboard/analytics"))
    return "Analytics";
  if (pathname.startsWith("/super-admin/dashboard/settings")) return "Settings";
