...
import { Receipt, Utensils, ArrowLeft } from 'lucide-react';
...
export default function StaffManagement() {
    return (
        <div className="min-h-screen bg-ruby-red relative overflow-hidden flex items-center justify-center p-8 font-sans">
            ...
            <Link href="/admin/dashboard" className="absolute top-8 left-8 z-20">
                <button className="p-3 rounded-lg bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 hover:border-gold-start/50 transition-all text-white">
                    <ArrowLeft size={24} />
                </button>
            </Link>
            ...
            <div className="max-w-6xl w-full mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                    <Link href="/admin/dashboard/staff/billing">
                        <motion.div
                    ...
                    <Link href="/admin/dashboard/staff/serving">
                        <motion.div
                            whileHover={{ y: -10, scale: 1.02 }}
                            whileTap={{ scale: 0.98 }}
                            className="bg-white/10 backdrop-blur-md p-14 rounded-3xl border border-white/10 flex flex-col items-center justify-center gap-8 cursor-pointer hover:border-gold-start/50 hover:bg-white/15 hover:shadow-[0_20px_60px_rgba(212,175,55,0.2)] transition-all duration-500 group"
